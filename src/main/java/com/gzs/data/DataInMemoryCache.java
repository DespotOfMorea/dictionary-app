...
public class DataInMemoryCache {
    ...
    private static volatile DataInMemoryCache instance;
    ...
    private DataInMemoryCache(){
        this.languages = new HashMap<>();
        this.terms = new HashMap<>();
        this.translations = new HashMap<>();
    }

    public static synchronized DataInMemoryCache getInstance(){
        if(instance == null){
            synchronized (DataInMemoryCache.class) {
                if(instance == null){
                    instance = new DataInMemoryCache();
                }
            }
        }
        return instance;
